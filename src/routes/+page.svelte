...
<div class="p-4 sm:ml-64">
	<div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
			<div class="flex items-center justify-center h-24 rounded bg-blue text-white dark:bg-darkBlue">
		...
		<div class="flex items-center justify-center h-48 mb-4 rounded bg-blue text-white dark:bg-darkBlue">
			<p class="text-2xl text-gray-400 dark:text-gray-500">Quick Actions</p>
		</div>
		<div class="grid grid-cols-2 gap-4 mb-4">
			<div class="flex items-center justify-center rounded bg-blue text-white h-28 dark:bg-darkBlue">
