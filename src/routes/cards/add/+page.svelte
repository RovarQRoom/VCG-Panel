		...
		<div>
			...
			<div class="bg-input-light dark:bg-input-dark border-0 rounded-xl relative">
				<div class="w-full h-auto flex justify-center items-center absolute gap-2">
					<svg width="40px" height="40px" viewBox="0 0 24 24" class="fill-blue dark:fill-white" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="mt-2 h-48 flex items-center justify-center overflow-hidden bg-input-light dark:bg-input-dark rounded-xl">
				{#if imagePreview}
					<img
						src={imagePreview}
						alt="Selected icon"
				...
				<TabItem open title={$_(key.toLowerCase())}>
					<div class="mt-4">
						...
						<Input
							...
							type="text"
							id="title-en"
							placeholder={$_('enter-card-title')}
					...
					<div class="mt-4">
						...
						<Textarea
							class="bg-input-light dark:bg-input-dark border-0"
							id="description-en"
							placeholder={$_('enter-card-description')}
